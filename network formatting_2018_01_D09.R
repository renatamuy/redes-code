...
##### Script: Script for formatting a matrix for using in different network programs
##### How to cite: Félix G.M. 2016. Script for formatting a matrix for using in
##### different network programs. Available at www.marcomello.org.
...
# Apply function for specified data extension

require(xlsx)

inputs("F://__data//networks//", files_type = ".txt")

inputs("F://__data//networks//", files_type = ".xlsx")
